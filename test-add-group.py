...
class TestMyfirsttestrecord():
  ...
  def test_myfirsttestrecord(self):
    ...
    self.driver.find_element(By.NAME, "group_header").send_keys("header-1")
    self.driver.find_element(By.NAME, "group_footer").send_keys("footer-1")
